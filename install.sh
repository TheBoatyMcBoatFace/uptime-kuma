...
# curl -o kuma_install.sh https://raw.githubusercontent.com/theboatymcboatface/uptime-kuma/master/install.sh && sudo bash kuma_install.sh
"echo" "-e" "====================="
...
"echo" "-e" "For advanced usage, please go to https://github.com/theboatymcboatface/uptime-kuma/wiki/Installation"
"echo" "-e" "---------------------------------------"
"echo" "-e" ""
...
if [ "$type" == "local" ]; then
  ...
  docker run -d --restart=always -p $port:3001 -v $volume:/app/data --name uptime-kuma theboatymcboatface/uptime-kuma:1
fi
