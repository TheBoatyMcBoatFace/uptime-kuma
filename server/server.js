...
(async () => {
    ...
    app.get("/.well-known/change-password", async (_, response) => {
        response.redirect("https://github.com/theboatymcboatface/uptime-kuma/wiki/Reset-Password-via-CLI");
    });
        ...
        socket.on("prepare2FA", async (currentPassword, callback) => {
            try {
                ...
                if (user.twofa_status === 0) {
                    ...
                    // Related issue: https://github.com/theboatymcboatface/uptime-kuma/issues/486
...
process.addListener("unhandledRejection", (error, promise) => {
    ...
    console.error("If you keep encountering errors, please report to https://github.com/theboatymcboatface/uptime-kuma/issues");
});
